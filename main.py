...
custom_caption = os.environ.get("custom_caption", "`{file_name}`\n\n**Powered By - @the_tgguy**") # Here You Can Give Anything, if You Want Real File Name Then Use {file_name}
...
about_message = """
<b>• Name : <a href=https://t.me/not_ur_robot>AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/Itsme123i>Itsme123i</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/the_tgguy>Telegram Guy!!</a></b>"""
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/the_tgguy"),
...
print("Bot Created By @the_tgguy")
